...
const Hero = () => {
  ...
  return (
    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#020617] via-[#020b1a] to-[#041b3a] relative overflow-hidden">
      {/* <div className="absolute inset-0 bg-grid-pattern opacity-10"></div> */}
      <div className="absolute w-[500px] h-[500px] bg-cyan-500/20 blur-[120px] rounded-full top-20 left-1/2 -translate-x-1/2"></div>
      {/* <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10"> */}
      <div className="w-full px-16 lg:px-24 py-20 relative z-10">
...
<h1 className="text-7xl md:text-8xl font-bold text-white mb-6 animate-[fadeUp_1.2s_ease-out]">
  I am <span className="text-cyan-400">Aarushi Thakur</span>
</h1>
  ...
  speed={50}
  repeat={Infinity}
  className="text-4xl md:text-3xl text-cyan-400 mb-10"
/>
          <p className="text-2xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto animate-fade-in-delay">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12 animate-fade-in-delay-2">
            <a
              ...
              className="bg-transparent border-2 border-cyan-400 hover:bg-cyan-400/10 text-cyan-400 px-20 py-5 text-lg rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
            >
              View Projects
            </a>
            <a
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <ArrowDown className="text-cyan-400" size={48} />
      </div>
    </section>
  );
};
